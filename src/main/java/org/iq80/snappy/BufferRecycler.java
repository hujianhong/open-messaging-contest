...
/**
 * Simple helper class to encapsulate details of basic buffer recycling scheme,
 * which helps a lot (as per profiling) for smaller encoding cases.
 *
 * @author tatu
 */
class BufferRecycler {
	 ...
	 * provide a low-cost buffer recycling for buffers we need for encoding,
	 * decoding.
	 */
